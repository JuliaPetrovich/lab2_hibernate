...
public class Menu {
    ...
    public void UserMenu(User currentUser) {
        ...
        while (Integer.parseInt(choice) != 7) {
            String s = "Меню пользователя\n" +
                    ...
                    "6. Работа с избранными машинами\n" +
                    "7. Выход\n" +
                    "Выбор: ";
            System.out.print(s);
            choice = in.nextLine();
    ...
    public void UserMenuFavorites(User currentUser) {
        String choice = "0";
        while (Integer.parseInt(choice) != 4) {
            String s = "Работа с избранными машинами\n" +
                    "1. Добавить машину в избранное\n" +
                    "2. Просмотреть избранные авто\n" +
                    "3. Удалить машину из избранных\n" +
                    "4. Выход\n" +
                    "Выбор: ";
            System.out.print(s);
            choice = in.nextLine();
            switch (choice) {
                case "1":
                    menuFunctions.addCarToFavorites(currentUser);
                    break;
                case "2":
                    menuFunctions.showFavorites(currentUser);
                    break;
                case "3":
                    menuFunctions.deleteCarFromFavorites(currentUser);
                    break;
                case "4":
                    break;
                default:
    ...
    public void AdminMenuWithBodyTypes() {
        String choice = "0";
        while (Integer.parseInt(choice) != 5) {
            String s = "Работа с типами кузовов\n" +
                    "1. Добавить новый тип кузова\n" +
                    "2. Изменить тип кузова\n" +
                    "3. Удалить тип кузова\n" +
                    "4. Вывести все типы кузовов\n" +
                    "5. Выход\n" +
                    "Выбор: ";
            System.out.print(s);
            choice = in.nextLine();
            switch (choice) {
                case "1":
                    menuFunctions.addBodyType();
                    break;
                case "2":
                    menuFunctions.updateBodyType();
                    break;
                case "3":
                    menuFunctions.deleteBodyType();
                    break;
                case "4":
                    menuFunctions.showBodyTypes();
                    break;
                case "5":
                    break;
                default:
